...
import { combatState, initCombat, rollInitiative, attack, defend, tackle, disengage, runAway, attemptWakeUp, nextTurn, getCurrentWeapon, } from './engine';
const appState = {
...
function updateCombatState() {
    ...
    if (!combatState.enemy)
        return;
    const turnText = combatState.currentTurn === 'player'
        ? 'YOUR TURN'
