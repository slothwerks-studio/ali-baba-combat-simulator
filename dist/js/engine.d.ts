...
export declare function attack(
  attacker: Combatant,
  defender: Combatant,
  isDefending: boolean,
): boolean;
export declare function defend(defender: Combatant): void;
export declare function tackle(
  attacker: Combatant,
  defender: Combatant,
): boolean;
export declare function disengage(
  attacker: Combatant,
  defender: Combatant,
): boolean;
export declare function runAway(runner: Combatant): void;
export declare function attemptWakeUp(combatant: Combatant): boolean;
export declare function getCurrentCombatant(): Combatant | null;
export declare function getOpponent(combatant: Combatant): Combatant | null;
